...
%	numberstyle=\color{mauve},
	keywordstyle=\color{black}, % Раскоментить это и закоментить morekeywords чтобы все ключевые слова были не жирным шрифтом
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\productcodefull}{АБВГ.ХХХХХ} % Код организации + Регистрационный код
\newcommand{\programname}{Галактический транклюкатор} % Название программы
\newcommand{\productname}{XXL} % Шифр (название) изделия
\newcommand{\productnamefirst}{XXL1}
\newcommand{\productnamesecond}{XXL2}
%\newcommand{\progr}{Программный комплекс <<\programname>>}% Только для спецификации!
...
\title{ИЗДЕЛИЕ~{\productname}\\СПЕЦИАЛЬНОЕ~ПРОГРАММНОЕ ОБЕСПЕЧЕНИЕ\\Комплекс программ\\ \MakeUppercase\programname} 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\firstapplication{АБВГ.ХХХХХХ.ХХХ} % Первое применение
...
%
% СОГЛАСОВАНО
\customerrank{Начальник~чего-то\\~\\~} % На двух строках
\customername{А.Б.~Кто-то} % \phantom - убирает видимость

% УТВЕРЖДАЮ
\chiefconstructorrank{Главный конструктор\\изделия \productname\\начальник чего-то}
\chiefconstructorname{А.Б.~Начальник}
%
\fromcustomerrank{От кого-то}
\fromcustomername{\phantom{А.Б.~Заказчиков}} % \phantom - убирает видимость
%
\deputyofchiefconstructorrank{Зам.~главного конструктора}
\deputyofchiefconstructorname{А.Б.~Замгэка}
%
\developerrank{Разработчик программы}
\developerrankafter{Разработчик алгоритма и комплекса программ}
\developername{А.Б.~Гениальный}

% Исполнитель(и)
\authorname{А.Б.~Инфузория}
%%
%\authori{А.Б.~Пацак1}
%\authorii{А.Б.~Пацак2}
